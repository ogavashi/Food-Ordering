...
<html>
  <head>
    ...
    <link
      rel="icon"
      href="https://www.flaticon.com/svg/vstatic/svg/2830/2830305.svg?token=exp=1618155492~hmac=20052fcf63cb94c3ba7f443dd8dde1fd"
    />
  </head>
  <body>
    <header>
      ...
      <div id="categories">
        <button onclick="window.location.href='<?php echo SITEURL; ?>food.php';" class="round-button">
          <div class="category">
            ...
            />
            <h2 сlass="category-name">Dishes</h2>
          </div>
        </button>
        <button onclick="window.location.href='<?php echo SITEURL; ?>drinks.php';" class="round-button">
          <img
            class="category-img"
            src="https://res.cloudinary.com/glovoapp/w_140,h_140,c_fit,f_auto,q_auto/StoreCategories/ft4i1ieyeatqfoqd4pdc"
          />
          <h2 сlass="category-name">Drinks</h2>
        </button>
        <button onclick="window.location.href='<?php echo SITEURL; ?>products.php';" class="round-button">
          <img
            class="category-img"
            src="https://res.cloudinary.com/glovoapp/w_140,h_140,c_fit,f_auto,q_auto/StoreCategories/pdnz24ln2tb5ia4268bk"
          />
          <h2 сlass="category-name">Products</h2>
        </button>
        <button onclick="window.location.href='<?php echo SITEURL; ?>snacks.php';" class="round-button">
          <img
            class="category-img"
            src="https://res.cloudinary.com/glovoapp/w_140,h_140,c_fit,f_auto,q_auto/StoreCategories/tprz7khmhksz4xrj7ufc"
          />
          <h2 сlass="category-name">Snacks</h2>
        </button>
        <button onclick="window.location.href='<?php echo SITEURL; ?>deserts.php';" class="round-button">
          <img
            class="category-img"
            src="https://res.cloudinary.com/glovoapp/w_140,h_140,c_fit,f_auto,q_auto/StoreCategories/vevdez89piflyonld84d"
          />
          <h2 сlass="category-name">Deserts</h2>
        </button>
      </div>
      <div id="best-food">
        ...
        <div class="products-list">
          <div class="full-card">
            <div class="card">
              <img
                src="https://eshop.kolkovna.sk/webcare/image/BFLEAAAABAYjBjZGRiZmU1OWM0N2ViNmE5OWQ2ORRXydZ5eoPMvdu7ENqAdgcnOI"
                alt="Tartar"
                style="width: 100%"
              />
              <h1>Tartar</h1>
          ...
          <div class="full-card">
            <div class="card">
              <img
                src="https://eshop.kolkovna.sk/webcare/image/BFLEAAAAEQYWZkMTM3NDBhMmJhNjQyNjYzNTFstb4r2zOxj86FJID97KtCPflrRm"
                alt="Wings"
                style="width: 100%"
              />
              <h1>Hot Wings</h1>
          ...
          <div class="full-card">
            <div class="card">
              <img
                src="https://eshop.kolkovna.sk/webcare/image/BFLEAAAABgNWM1NGZmMzJhMGYxOTk1MjE3NTl12DJ67k7SlOJuA0o5MXLBniJvk4"
                alt="Cesar"
                style="width: 100%"
              />
              <h1>Cesar</h1>
