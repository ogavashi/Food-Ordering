      ...
      <span class="category-filters">
        <div class="filters-category">
          <div>
            <div class="filters">
              <?php
              $sql = "SELECT * FROM category WHERE id_type = 2";
    ...
    <div id="best-food">
      <div class="products-list">
        ...
        $sql2 = "SELECT product.*, category.id_type FROM product, category INNER JOIN type on 
          category.id_type = type.id_type WHERE product.id_category = category.id_category AND category.id_type = 2";
