...
<body>
      ...
      <span class="category-filters">
        <div class="filters-category">
          <div>
            <div class="filters">
              <?php
              $sql = "SELECT * FROM category WHERE id_type = 4";
    ...
    <div id="best-food">
      <div class="products-list">
        ...
        $sql2 = "SELECT product.*, category.id_type FROM product, category INNER JOIN type on 
          category.id_type = type.id_type WHERE product.id_category = category.id_category AND category.id_type = 4";
        ...
        ?>
            <div class="full-card">
              <div class="card">
                <img src="/images/food/<?php echo $image_name ?>" alt="Tartar" style="width: 100%; height: 320px; width: 480px" />
  ...
  if (isset($_GET['submit'])) {
    ...
    if ($res == TRUE) {
      header('location:' . SITEURL . 'snacks.php');
    } else {
      header('location:' . SITEURL . 'snacks.php');
    }
  }
